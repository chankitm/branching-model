...
public enum RestServerResponseCode{
	...
	//Video Express 2B
	NO_MACHINE_NAME("NO_MACHINE_NAME"),
	NOT_CURRENT_SVOD_CLIENT("NOT_CURRENT_SVOD_CLIENT"),
	NO_QUOTA("NO_QUOTA"),
	
	//Self-service Subscription
	ACCOUNT_IS_INACTVIE("ACCOUNT_IS_INACTVIE"),
	DEPENDENCY_FAIL("DEPENDENCY_FAIL"),
	ERROR_BUYTHRU("ERROR_BUYTHRU"),
	PLAN_ALREADY_SUBSCRIBE("PLAN_ALREADY_SUBSCRIBE");
