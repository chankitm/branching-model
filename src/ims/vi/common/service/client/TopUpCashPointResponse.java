...
public class TopUpCashPointResponse extends APIResponse{
	private String cashPointBalance;
	private Date expiryDate;
	public static final String SERVERTYPE = ServerType.TOPUPCP.getType();
	
	public TopUpCashPointResponse(){
	}
	
	public TopUpCashPointResponse(RestServerResponseCode responseCode, String callerReferenceNo, String serverReferenceNo, long elapsedTime, String cashPointBalance, Date expiryDate){
