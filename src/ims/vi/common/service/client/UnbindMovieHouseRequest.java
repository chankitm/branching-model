...
public class UnbindMovieHouseRequest extends APIRequest{
	private String npid;
	private String fsa;
	
	public UnbindMovieHouseRequest(){
	}
	
	public UnbindMovieHouseRequest(String callerID, String callerReferenceNo, String version, String npid, String fsa) {
	...
	public Class getResponseClass(){
		return UnbindMovieHouseResponse.class;
	}
	@Override
