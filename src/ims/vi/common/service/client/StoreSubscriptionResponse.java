...
public class StoreSubscriptionResponse extends APIResponse {
	public static final String SERVERTYPE = ServerType.MOVIEHOUSE.getType();
	private boolean approved;

	public StoreSubscriptionResponse(){
		
	}
	
	public StoreSubscriptionResponse(boolean approved, RestServerResponseCode responseCode, String callerReferenceNo, String serverReferenceNo, long elaspedTime){
