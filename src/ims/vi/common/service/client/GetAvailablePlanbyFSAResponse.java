...
public class GetAvailablePlanbyFSAResponse extends APIResponse {
	private List<CampaignPlanDetail> campaignPlanDetail;

	public GetAvailablePlanbyFSAResponse() {
		super();
	}

	public GetAvailablePlanbyFSAResponse(RestServerResponseCode responseCode,
